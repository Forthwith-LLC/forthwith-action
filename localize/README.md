...
Copy the [public localization PR workflow template](../examples/forthwith-localize.yml)
...
Commit a valid `.forthwith.yml` at the repository root. The template starts
